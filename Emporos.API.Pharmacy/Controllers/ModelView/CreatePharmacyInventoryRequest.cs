...
{
    public class CreatePharmacyInventoryRequest
    {
        ...
        public class CreatePharmacyInventoryRequestValidator : AbstractValidator<CreatePharmacyInventoryRequest>
        {
            public CreatePharmacyInventoryRequestValidator()
            {
