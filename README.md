...
3. You have to request a Token from the Authentication service before sendind data to the PaymentInventory service, otherwise it will show Unauthorized. This token need to be sent in any request to the PaymentInventory service.
